...
typedef enum {
    FC_EXPER,
    FC_HOOK_TRIGGER_NETIF,
    FC_HOOK_TRIGGER,
    FC_HOOK_UDP_SEND,
    FC_HOOK_UDP_RECV,
    FC_HOOK_TRIGGER_FC,
    FC_HOOK_RPL_SEND_DIS, // 6
    FC_HOOK_RPL_SEND_DIO, // 7
    FC_HOOK_RPL_SEND_DAO, // 8
    FC_HOOK_RPL_SEND_DAO_ACK, // 9 
    FC_HOOK_RPL_PARSE_OPTIONS, //10 
    FC_HOOK_RPL_RECV_DIS,// 11 
    FC_HOOK_RPL_RECV_DIO,// 12
    FC_HOOK_RPL_RECV_DAO, // 13 
    FC_HOOK_RPL_RECV_DAO_ACK, // 14
    FC_HOOK_RPL_ROOT, // 15
    FC_HOOK_NUM,
} f12r_hook_trigger_t;
...
typedef struct {
    ...
    uint8_t *application; /**< Application bytecode */
...
typedef uint32_t (*f12r_call_t)(f12r_t *bpf, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5);
