                                 ...
                                 icmpv6_echo_t *echo, uint16_t len)
{
    ...
    char addr_str[128];
    DEBUG("icmpv6_echo - src: %s, ", ipv6_addr_to_str(addr_str, &ipv6_hdr->src, sizeof(addr_str)));
    DEBUG("dst: %s\n", ipv6_addr_to_str(addr_str, &ipv6_hdr->dst, sizeof(addr_str)));

    DEBUG("icmpv6_echo_reply - src: %s, ", ipv6_addr_to_str(addr_str, &((ipv6_hdr_t *)hdr->data)->src, sizeof(addr_str)));
    DEBUG("dst: %s\n", ipv6_addr_to_str(addr_str, &((ipv6_hdr_t *)hdr->data)->dst, sizeof(addr_str)));
