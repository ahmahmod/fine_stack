                      ...
                      nanocbor_value_t *_it)
{
    ...
    if (0) {}
        ...
        //     LOG_INFO("Data downlaoding time = %"PRIu32" msec\n", (local_end - local_start));
        // }
        // #endif
    }
#endif
                                   ...
                                   nanocbor_value_t *_it)
{
    ...
    local_end = ztimer_now(ZTIMER_MSEC);
        if (local_end>local_start){
            LOG_INFO("Image verification time = %"PRIu32" msec\n", (local_end - local_start));
        }
    #endif
    return res;
}
...
const suit_manifest_handler_t suit_command_sequence_handlers[] = {
    ...
    /*// Custom post-install handler
    [SUIT_CUSTOM_COMMAND_POST_INSTALL] = suit_custom_post_install_handler,*/
};
